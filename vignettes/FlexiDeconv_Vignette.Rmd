...
p <- visualizeReference(mouseHypothalamus$ground_truth_geneexp)
p
```
...
```{r, fig.width=5, fig.height=3, dpi=150}
cellType = 'OD Mature'
cellType_idx = which(colnames(mouseHypothalamus$ground_truth_deconv) == cellType)
plotDeconvRes(mouseHypothalamus$ground_truth_deconv,
              mouseHypothalamus$spatial_meta,
              color = color,
              numRow = 1,
...
#                         mouseHypothalamus$ground_truth_geneexp["OD Mature",]))
